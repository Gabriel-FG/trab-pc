  ...
  <div id="index-banner" class="parallax-container valign-wrapper">
    <div class="section no-pad-bot">
      <div class="container valign">
        <br><br>
        <h1 class="header center blue-text text-darken-2">Site do Gabriel Figueiredo</h1>
        <div class="row center">
          <h5 class="header col s12 light blue-text text-darken-2">Posts FASA</h5>
        </div>
        <div class="row center">
      ...
      <div class="parallax"><img src="{{asset('blog/images/teclando.jpg')}}" alt="Unsplashed background img 2" style = "width:1280px";"height:720px"></div>
  </div>
