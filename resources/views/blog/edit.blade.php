...
<div class="container" id="startPosts">
    ...
    <div class="row">
        <div class="col s12 m10 offset-m1 l9 offset-l1">
            ...
            <form class="col s12" action="{{route('admin.update', ['id'=>$post->id])}}" method="post">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <input name="titulo" value="{{$post->titulo}}" id="message-sub" type="text" class="validate">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <textarea name="conteudo" id="text_area" class="materialize-textarea">{{$post->conteudo}}</textarea>
